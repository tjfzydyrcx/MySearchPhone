...
import com.example.my360windowmanager.Utils.ScreenSizeUtil;
...
public class ShowMaxImageView extends ImageView {
    ...
    private void getHeight(Bitmap bm) {
        ...
        float bitmapWith = bm.getWidth();
        float bitmapHeight = bm.getHeight();
        if (bitmapWith > 0 && bitmapHeight > 0) {
            float scaleWidth = getWidth() / bitmapWith;
            if (scaleWidth != 0) {
