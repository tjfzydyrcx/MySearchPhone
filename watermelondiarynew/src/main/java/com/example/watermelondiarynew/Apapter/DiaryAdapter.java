package com.example.watermelondiarynew.Apapter;
...
import com.example.watermelondiarynew.R;
...
public class DiaryAdapter extends RecyclerView.Adapter <DiaryAdapter.DiaryViewHolder>{
    ...
    public DiaryAdapter(Context mContext, List<DiaryBean> mDiaryBeanList) {
